...
namespace GMap.NET.WindowsForms.Markers
{
...
#endif
   {
      ...
      {
         var p1 = new PointF(LocalPosition.X, LocalPosition.Y);
         p1.Offset(0, -10);
         var p2 = new PointF(LocalPosition.X, LocalPosition.Y);
         p2.Offset(0, 10);

         var p3 = new PointF(LocalPosition.X, LocalPosition.Y);
         p3.Offset(-10, 0);
         var p4 = new PointF(LocalPosition.X, LocalPosition.Y);
         p4.Offset(10, 0);
