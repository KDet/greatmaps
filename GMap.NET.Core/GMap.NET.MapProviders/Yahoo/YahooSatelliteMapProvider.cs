...
namespace GMap.NET.MapProviders
{
   ...
   public class YahooSatelliteMapProvider : YahooMapProviderBase
   {
      ...
      #region GMapProvider Members
       ...
       private readonly Guid id = new Guid("55D71878-913F-4320-B5B6-B4167A3F148F");
      public override Guid Id
      {
       ...
       private readonly string name = "YahooSatelliteMap";
       ...
       private string MakeTileImageUrl(GPoint pos, int zoom, string language)
      {
       ...
       private static readonly string UrlFormat = "http://maps{0}.yimg.com/ae/ximg?v={1}&t=a&s=256&.intl={2}&x={3}&y={4}&z={5}&r=1";
   }
}
