...
namespace GMap.NET.MapProviders
{
	...
	public class GMapProviders
	{
		...
		public static readonly OpenStreetMapQuestSatteliteProvider OpenStreetMapQuestSattelite =
			OpenStreetMapQuestSatteliteProvider.Instance;
